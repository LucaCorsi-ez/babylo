 ...
 */
export declare type AppendScenePhase = "sceneLoading" | "filesLoading";
/**
 ...
 */
export declare function appendScene(toScene: Scene, rootUrl: string, sceneFilename: string, onProgress?: (progress: ISceneLoaderProgressEvent, phase: AppendScenePhase) => void): Promise<void>;
/**
 ...
 */
export declare let ssrRenderingPipelineRef: Nullable<SSRRenderingPipeline>;
/**
 ...
 */
export declare function handleTexturesLods(scene: Scene, rootUrl: string): void;
